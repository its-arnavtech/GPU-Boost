"""Controlled DataLoader optimized workload."""
...
def main() -> None:
    ...
    pin_memory = (
        ...
        else bool(args.pin_memory and cuda_available)
    )
    ...
    def step() -> int:
        ...
        batch = batch.to(device, non_blocking=cuda_available)
        target = target.to(device, non_blocking=cuda_available)
